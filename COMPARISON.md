...
- [Coding Interview Comparison](#coding-interview-comparison)
...
| **Data breach history** | ✅ None | ❌ 83,000 users exposed (2025) |
| **Any LLM support** | ✅ GPT, Claude, Gemini, Groq, Ollama | ❌ Vendor-locked |
| **Offline mode** | ✅ Via Ollama | ❌ Requires internet |
| **Real-time latency** | ✅ <500ms | ⚠️ 5–90s reported |
| **Dual audio channels** | ✅ System + Mic | ❌ Single stream |
| **Local RAG memory** | ✅ SQLite + sqlite-vec | ❌ |
| **Meeting history dashboard** | ✅ Full dashboard | ⚠️ Limited |
| **Screenshot / OCR** | ✅ | ⚠️ Limited |
| **Stealth mode** | ✅ Undetectable | ❌ |
| **Process disguise** | ✅ | ❌ |
| **Resume / JD context** | ✅ Pro | ❌ |
| **Negotiation copilot** | ✅ Pro | ❌ |
| **Company research** | ✅ Pro | ❌ |

### The Cluely Data Breach
...
| **Open source** | ✅ | ❌ |
| **Real-time latency** | ✅ <500ms | ⚠️ Slowest in category |
| **Stealth mode** | ✅ Undetectable | ❌ Taskbar icon visible to proctors |
| **Detectable by proctoring software** | ✅ No | ❌ Yes |
| **Local data** | ✅ | ❌ Cloud |
| **Any LLM (BYOK)** | ✅ | ❌ Vendor-locked |
| **Offline mode** | ✅ Ollama | ❌ |
| **Dual audio channels** | ✅ | ❌ |
| **Local RAG memory** | ✅ | ❌ |
| **Mock interview mode** | ❌ | ✅ |
...
| **Screenshot + OCR** | ✅ | ✅ |
| **Real-time overlay** | ✅ | ✅ |
| **Undetectable on standard platforms** | ✅ | ✅ |
| **Any LLM (BYOK)** | ✅ | ❌ Locked |
| **Local / offline AI** | ✅ Ollama | ❌ |
| **Local data storage** | ✅ | ❌ Cloud |
...
| Platform | Detectable? |
| :--- | :---: |
| LeetCode | ✅ Not detectable |
| HackerRank | ✅ Not detectable |
| CoderPad | ✅ Not detectable |
| Codility | ✅ Not detectable |
| HackerEarth | ✅ Not detectable |
| Karat | ✅ Not detectable |
| Pearson VUE | ⚠️ Not designed for OS-level proctoring |
...
| **Local data** | ✅ | ❌ Cloud |
| **Local RAG memory** | ✅ | ❌ |
| **Meeting history** | ✅ Full dashboard | ❌ |
...
| **Local data** | ✅ | ✅ |
| **Local RAG memory** | ✅ SQLite + vec | ❌ |
| **Meeting history** | ✅ Full dashboard | ❌ |
| **Dual audio channels** | ✅ | ❌ |
| **Screenshot / OCR** | ✅ | ❌ |
| **Stealth mode** | ✅ | ❌ |
| **Any LLM (BYOK)** | ✅ | ⚠️ Limited |
| **Offline mode** | ✅ Ollama | ❌ |
...
| **Company research** | ✅ Pro | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| **Linux support** | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ |
| **Data breach history** | ✅ None | ❌ 83k users | ✅ None | ✅ None | ✅ None | ✅ None | ✅ None |
...
| **LockedIn AI** | ❌ Cloud | Unknown | ✅ None known | ❌ |
| **Interview Coder** | ❌ Cloud | Unknown | ✅ None known | ❌ |
